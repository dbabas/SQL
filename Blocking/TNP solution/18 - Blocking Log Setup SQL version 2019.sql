...
BEGIN
	...
	BEGIN TRY
		...
		CREATE TABLE #SysProcesses (spid smallint,blocked smallint,waittime bigint,lastwaittype nchar(32),waitresource nchar(256),
					dbid smallint,cpu int,status nchar(30),hostname nchar(128),LastBatch DATETIME,cmd nchar(26),loginame nchar(128),sql_handle binary(20))  
		Set @i = 0 
